...
namespace Bookify.Services.Booking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920223640_AddBookingReferenceAndLifecycleMetadata")]
    partial class AddBookingReferenceAndLifecycleMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Services.Booking.Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("payments", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_payments_completion_consistency", "(status IN ('Succeeded', 'Cancelled') AND completed_at_utc IS NOT NULL) OR (status IN ('Pending', 'Failed') AND completed_at_utc IS NULL)");

                            t.HasCheckConstraint("ck_payments_status", "status IN ('Pending', 'Succeeded', 'Failed', 'Cancelled')");
                        });
                });

            modelBuilder.Entity("Bookify.Services.Booking.Domain.Payments.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex(new[] { "PaymentId" }, "IX_payment_attempts_payment_id");

                    b.ToTable("payment_attempts", null, t =>
                        {
                            t.HasCheckConstraint("ck_payment_attempts_amount", "amount > 0");

                            t.HasCheckConstraint("ck_payment_attempts_completion_consistency", "(status = 'Pending' AND completed_at_utc IS NULL) OR (status IN ('Succeeded', 'Failed', 'Cancelled') AND completed_at_utc IS NOT NULL)");

                            t.HasCheckConstraint("ck_payment_attempts_status", "status IN ('Pending', 'Succeeded', 'Failed', 'Cancelled')");
                        });
                });
            ...
            modelBuilder.Entity("Bookify.Services.Booking.Domain.Payments.Payment", b =>
                {
                    b.HasOne("Bookify.Services.Booking.Domain.Bookings.Booking", null)
                        .WithOne()
                        .HasForeignKey("Bookify.Services.Booking.Domain.Payments.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("Bookify.Services.Booking.Domain.Shared.ValueObjects.Money", "Amount", b1 =>
                        {
            ...
            modelBuilder.Entity("Bookify.Services.Booking.Domain.Payments.PaymentAttempt", b =>
                {
                    b.HasOne("Bookify.Services.Booking.Domain.Payments.Payment", null)
                        .WithMany("Attempts")
                        .HasForeignKey("PaymentId")
